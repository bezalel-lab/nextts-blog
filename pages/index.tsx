...
export default function Home({
  ...
  return (
    <Layout home>
      ...
      <section className={`${utilStyles.headingMd}`}>
        <div className={`${utilStyles.sectionWidth}`}>
          <p>
            ...
            （25歳）です。フロントエンドエンジニアを目指しており、ウェブ開発の基礎、Next.js、TypeScript、コンピュータ・サイエンスその他の独学に1000時間ほどを用いました。ほとんどは公式ドキュメントを読んで学習しました。
          </p>
          <p>
      ...
      >
        <h2 className={`${utilStyles.headingLg} ${utilStyles.EnglishHeading}`}><span className={`${utilStyles.EnglishCheck}`}>☑</span>Blog</h2>
